...
המלל החופשי הוא מרכז ההחלטה (כ-90%). רמת הקושי שנבחרה (קל/בינוני/מאתגר) היא אילוץ
בטיחותי קשיח שחייב להישמר בקפדנות בכל מקרה - אל תדרג גבוה מסלול שלא מתאים לרמת
הקושי המבוקשת, גם אם הצ'אט מבקש אחרת (זהו אחד המקרים שבהם חוקי המערכת גוברים
על ה-Intent, ר' סעיף 3 במפרט).
