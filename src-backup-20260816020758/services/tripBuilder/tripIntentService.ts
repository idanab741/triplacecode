...
היררכיית מקורות המידע (בהתאם לכלל העליון של המערכת):
- מלל חופשי: כ-90% מהמשקל - זהו מרכז ההבנה, לא הערה נלווית.
- תשובות השאלון ופרופיל/העדפות קודמות: יחד כ-10% - context משלים, מחדדים ולא קובעים.
