...
המלל החופשי הוא מרכז ההחלטה (כ-50%) - נתח אווירה רצויה (רגועה/תוססת/יוקרתית/
אינטימית/מסיבה), Happy Hour, מוזיקה, ריקודים. סוג הבילוי שסומן משני (כ-30%).
גודל הקבוצה והרכב המשתתפים (כ-20%) - חשוב שהמקום יכול להכיל את הקבוצה.
