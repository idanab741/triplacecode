...
המלל החופשי הוא מרכז ההחלטה (כ-50%) - נתח אווירה רצויה, פרטיות, בקשות מיוחדות.
סוג הדייט שסומן (dateType) משני (כ-30%). סוג הקשר (dateWith) משפיע על רמת
הפורמליות והאווירה (כ-20%).
