 ...
 */
/* *** מבנה ניווט חדש (בקשה מפורשת): מה שהיה עמוד הבית (ערימת הכרטיסיות +
 * "הטיולים שלי" / "כל מה שחם" / גילוי / קרוב אליי) עבר לכאן - לשונית
 * tripmatch (הכפתור האמצעי עם העיגול המסתובב). עמוד הבית מציג עכשיו את
 * הפיד (לשעבר place's), ו-place's מציג את המפה. */
export default function TripMatchHomePage() {
  ...
  return (
    ...
    >
      ...
      <MainBottomNav active="tripmatch" />
    </div>
  );
}
