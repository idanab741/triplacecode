...
export async function POST(request: Request) {
  ...
  try {
    // *** תיקון (בקשה מפורשת - "עמוד tripmatch, כרטיסי 'הכל' מיד"):
    // includeAllCategories היה מועבר הלאה רק כשיש lat/lng ("קרוב אליי") -
    // חיפוש עיר רגיל תמיד איבד את הדגל הזה כאן, גם כשהלקוח שלח אותו.
    // עכשיו מועבר בכל מקרה, בלי תלות בחיפוש גיאוגרפי.
