...
import { TripHeroHeader, WHITE_ICON_FILTER } from "@/screens/layout/TripHeroHeader";
...
function NightlifeResultContent() {
    ...
    return (
      <Screen>
        <div className="pt-10 text-center text-ink-secondary">
          <p>לא נבחרו מספיק תחנות כדי לבנות ערב.</p>
  ...
  return (
    <Screen withBottomNavSpacing={true} className="!bg-white !px-0 !pt-0">
      <TripHeroHeader
        ...
        heroAlt="הערב שלכם מוכן"
        onBack={() => router.push("/home")}
        dark
        rightSlot={
          <>
            <SaveTripIconButton sessionId={sessionId} iconClassName={WHITE_ICON_FILTER} />
            <button
              type="button"
      ...
      <div className="mx-auto flex max-w-xl flex-col gap-5 px-5 pb-10 pt-0">
        <div className="flex items-start justify-between">
          <div>
            <h1 className="text-xl font-bold text-ink">הערב שלכם מוכן!</h1>
