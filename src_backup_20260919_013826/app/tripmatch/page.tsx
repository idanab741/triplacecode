                ...
                <div className="relative h-full">
                  ...
                  {visibleCandidates.length > 1 && (
                    <>
                      <div
                        aria-hidden="true"
                        className="absolute inset-x-0 top-0 rounded-[28px] bg-white shadow-[0_8px_24px_rgba(16,24,40,0.10)]"
                        style={{ height: "calc(100% - 64px)", transform: "rotate(-5deg)", transformOrigin: "50% 100%" }}
                      />
                      <div
                        aria-hidden="true"
                        className="absolute inset-x-0 top-0 rounded-[28px] bg-white shadow-[0_10px_28px_rgba(16,24,40,0.12)]"
                        style={{ height: "calc(100% - 64px)", transform: "rotate(4deg)", transformOrigin: "50% 100%" }}
                      />
                    </>
                  )}
