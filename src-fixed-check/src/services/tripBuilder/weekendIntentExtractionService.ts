...
דוגמאות מפורשות לאיסור הסקה יתר (אל תעשה את זה, גם אם זה נשמע סביר):
- "אנחנו זוג" - אל תסיק weekendStyles=["romantic"] רק בגלל זה.
- "אנחנו חברים" - אל תסיק weekendStyles=["nightlife"] רק בגלל זה.
- "רוצים טבע" - אל תסיק weekendStyles=["romantic","spa_wellness"] בנוסף, גם אם זה "מסתדר" עם טבע.
- budgetPerPerson="unlimited" רק אם נאמר במפורש שהתקציב לא משנה/אין הגבלה -
  לא רק כי המשתמש לא הזכיר תקציב בכלל (במקרה כזה - null).
חלץ אך ורק את מה שנאמר, לא את מה שסביר להניח.
